...
public class Tab2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View vi = inflater.inflate(R.layout.tab2, container, false);
        final String showResultKey = "com.easy_binom.easybin.resultKey";
        SharedPreferences prefs = this.getActivity().getSharedPreferences(
                "com.easy_binom.app", Context.MODE_PRIVATE);
        final SharedPreferences.Editor editor = prefs.edit();
        final EditText editText1 = (EditText) vi.findViewById(R.id.editText21);
        final EditText editText2 = (EditText) vi.findViewById(R.id.editText22);
        ...
        FloatingActionButton floatingActionButton2 = (FloatingActionButton) vi.findViewById(R.id.fab2);
